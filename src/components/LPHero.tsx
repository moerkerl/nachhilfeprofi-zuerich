...
export default function LPHero({ 
  ...
  return (
    <>
      ...
      <section className="bg-white md:bg-gradient-to-br md:from-purple-50 md:to-white py-20 lg:py-24 mt-2 md:mt-0">
            ...
            <div className="space-y-8 sm:space-y-6 text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start">
                <button 
                  onClick={handleClick}
                  className={`
                    bg-[#7C3AED] text-white px-8 py-4 rounded-lg font-semibold text-lg shadow-lg
                    hover:bg-[#6D28D9] hover:shadow-xl transform hover:-translate-y-0.5 
                    transition-all cursor-pointer
                    ${shouldHighlight ? 'button-highlight ring-2 ring-purple-400 ring-opacity-50' : ''}
                  `}
                >
                  {buttonText}
                </button>
