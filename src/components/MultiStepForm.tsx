      ...
      {step <= 5 && (
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <div className="text-[#7C3AED] font-semibold">Frage {step} von 5</div>
      ...
      {step === 1 && (
        <form onSubmit={handleNext}>
          ...
          <div className="flex justify-between mt-8">
            ...
            <button 
              type="submit" 
              className="bg-[#7C3AED] text-white px-8 py-3 rounded-lg hover:bg-[#6D28D9] transition-colors font-semibold cursor-pointer"
            >
              Weiter
            </button>
          </div>
      ...
      {step === 2 && (
        <form onSubmit={handleNext}>
          ...
          <select 
            ...
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-[#7C3AED] focus:outline-none text-gray-700"
          >
          ...
          <div className="flex justify-between mt-8">
            <button 
              type="button" 
              className="text-[#7C3AED] hover:text-[#6D28D9] font-medium cursor-pointer"
              onClick={handleBack}
            >
              ← Zurück
            </button>
      ...
      {step === 3 && (
        <form onSubmit={handleNext}>
          ...
          <input 
            ...
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-[#7C3AED] focus:outline-none text-gray-700 mb-4"
      ...
      {step === 5 && (
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between mt-8">
            ...
            <button 
              type="submit" 
              className="bg-[#7C3AED] text-white px-8 py-3 rounded-lg hover:bg-[#6D28D9] transition-colors font-semibold disabled:opacity-50 cursor-pointer"
              disabled={loading}
            >
